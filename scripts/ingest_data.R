...
# RENAME ====
# rename 'n paar van die veranderlikes'
# educ, salary etc
#
# Funksie
# argumente: data
# produseer iets wat presies is soos pooled_2002
#
# Toets deur identical funksie te skeryf wat toets dat dit dieslefde ding doen as hier onder
