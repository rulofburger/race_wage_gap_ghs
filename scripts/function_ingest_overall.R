...
#test
pooled_2002_2 <- ingest_2002_2008(person_2002, worker_2002, age, salary, salary_categories_table = salarycategories_2002_2012, salperiod, educvar, recoding_table = recoding_educ_2002)



ingest_2009_2014 <- function(df1, age, salary, salperiod, educvar, recoding_table) {
...
pooled_2009_2 <- ingest_2009_2014(person_2009, age, salary, salperiod, educvar, recoding_table = recoding_educ_2009)


ingest_2015_2018 <- function(df1, age, salary, salperiod, educvar, recoding_table) {
...
pooled_2015_2 <- ingest_2015_2018(person_2015, age, salary, salperiod, educvar, recoding_table = recoding_educ_2015)


ingest_2019_2021 <- function(df1, age, salary, salperiod, educvar, recoding_table) {
...
pooled_2019_2 <- ingest_2019_2021(person_2019, age, salary, salperiod, educvar, recoding_table = recoding_educ_2019)
